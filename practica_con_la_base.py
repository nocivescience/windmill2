...
class WindmillScene(Scene):
    ...
    def start_leaving_shadows(self):
        self.CONFIG['leave_shadows'] = True
    ...
    def update_counter(self, counter):
        dist = np.linalg.norm(counter.point - counter.windmill.pivot)
    ...
    def add_points(self):
        ...
        self.wait()
        self.play(
            S.animate.next_to(dots, LEFT,buff= 2, aligned_edge= UP),
            FadeOut(braces),
            FadeOut(eq),
        )
    ...
    def continue_and_count(self):
        ...
        self.let_windmill_run(windmill, self.CONFIG['final_run_time'])